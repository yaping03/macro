...
if __name__ == '__main__':
    ...
    t_l = []
    for sub in range(1,571):
        print(sub)
        url = "http://ccsipb.lnu.edu.cn/bio_data_bacteria/index.php/c_front_bacteria/queryById/LNUB%03d"%sub
        # url = "http://ccsipb.lnu.edu.cn/bio_data_bacteria/index.php/c_front_fungus/queryById/F%d"%sub
        # url = "http://ccsipb.lnu.edu.cn/bio_data_bacteria/index.php/c_front_fungus/queryById/LNUF%d"%sub
    ...
    cursor.insert_fungus_detail(det_l)
    cursor.finished()
